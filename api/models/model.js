 ...
 */
   class Animal {
    constructor(name, species, age, isPet) {
        this.name = name;
...
/* Task 1 - Part 2. Replace these three instances of the example Class Resource with instances
   of your own class */
model.add(new Animal("Fluffy", "Cat", 3, true));
model.add(new Animal("Rex", "Dog", 5, true));
model.add(new Animal("Spike", "Hedgehog", 1, false));
